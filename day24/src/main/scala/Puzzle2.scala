...
object Puzzle2
{
    ...
    def solveMaze(walls: List[Wall], blizzards: List[Blizzard],
        ...
        start: (Int, Int), end: (Int, Int)): Option[(Int, List[Blizzard])] =
    {
    ...
    def main(args: Array[String]): Unit =
    {
        ...
        solveMaze(walls, blizzards, minX, maxX, minY, maxY, start, end)
                .flatMap(t => solveMaze(walls, t._2, minX, maxX, minY, maxY, end, start)
                    .map(e => (t._1 + e._1, e._2)))
                .flatMap(t => solveMaze(walls, t._2, minX, maxX, minY, maxY, start, end)
                    .map(e => t._1 + e._1)) match {
